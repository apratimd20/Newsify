            ...
            <div className="flex justify-between items-center">
              <div className="relative w-full max-w-[140px]">
                <select 
                  value={lang} 
                  onChange={handleLang}
                  className="w-full appearance-none rounded-md pl-3 pr-8 py-2 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
                  <option value="hi">Hindi</option>
                  <option value="en">English</option>
                </select>
